...
<div class="category-grid" markdown="0">
  ...
  <a href="{{ '/cyberdefender-writeups/endpoint%20forensics/' | relative_url }}" class="category-card">
    ...
    <p>Memory and disk forensics on compromised hosts.</p>
    <span class="category-count">7 writeups</span>
  </a>
  ...
  <a href="{{ '/cyberdefender-writeups/threat%20hunting/' | relative_url }}" class="category-card">
    ...
    <p>Proactive hunts for IOCs and adversary behavior across logs.</p>
    <span class="category-count">2 writeups</span>
  </a>
</div>
